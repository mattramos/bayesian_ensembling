...
project = "Bayesian Ensembles"
copyright = "2022, Matthew Amos and Thomas Pinder"
author = "Matthew Amos and Thomas Pinder"

# The full version, including alpha/beta/rc tags
version = find_version("ensembles", "__init__.py")
release = version
...
latex_documents = [
    ("contents", "ensembles.tex", "Bayesian Ensembles", "Thomas Pinder"),
]
...
texinfo_documents = [
    (
        "contents",
        "ensembles",
        "Bayesian Ensemlbes Documentation",
        "Matthew Amos and Thomas Pinder",
        "Ensembles",
